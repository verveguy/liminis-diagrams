 ...
 * genuinely this site's: which theme it is in. `useIsDarkMode` ships alongside
 * the component for hosts following the `data-theme` convention, which
 * Starlight does.
 *
 * The remark plugin imports this file rather than the package directly, so
