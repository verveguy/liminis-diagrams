...
```
<picture><source media="(prefers-color-scheme: dark)" srcset="./diagrams/playground-1-dark.svg" /><img src="./diagrams/playground-1.svg" alt="Diagram 1 from playground.mdx" /></picture>
