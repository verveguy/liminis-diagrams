...
```
<img src="./diagrams/architecture-1.svg" alt="Diagram 1 from architecture.mdx" />

`./react` is presentational plus interaction (drag), and knows nothing about Lexical,
editors, or persistence — see the [Limitations](/liminis-diagrams/#limitations--read-this-first)
...
See [`recipes.md`](/liminis-diagrams/recipes/) for complete, runnable examples of the first two.
